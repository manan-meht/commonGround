      ...
      <main className="flex-grow max-w-2xl mx-auto px-margin-mobile py-stack-lg">
        ...
        <div className="bg-error-container/20 border border-error/20 rounded-xl p-6 mb-8">
          ...
          <ul className="space-y-2 font-body-md text-on-error-container/80">
            <li>• Urushi Labs is an AI communication facilitation tool, <strong>not</strong> a therapy service, mediation service, or legal service.</li>
        ...
        <div className="space-y-6 font-body-md text-on-surface-variant">
          <section>
            ...
            <p>Urushi Labs is an early-stage prototype. Features may change, data may be lost, and the service may be interrupted without notice.</p>
          </section>
