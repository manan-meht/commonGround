...
const CATEGORY_MESSAGES: Record<string, { title: string; body: string }> = {
  ...
  possible_self_harm_or_violence: {
    ...
    body: 'This report identified content that may indicate risk of self-harm or physical violence. Please reach out to a crisis support service or emergency services if you or someone else is in immediate danger. Urushi Labs cannot assess immediate risk or provide crisis support.',
  },
  ...
  return (
    <main className="flex-grow max-w-2xl mx-auto px-margin-mobile py-stack-lg flex flex-col items-center text-center">
      ...
      <p className="text-label-sm text-on-surface-variant mt-8 max-w-md opacity-70">
        Urushi Labs is an AI communication tool. It cannot verify facts, assess danger, or replace
